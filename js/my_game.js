...
function stopZombie() {
    ...
    document.querySelector("#character").style.backgroundImage = "url('http://meetstephen.dk/KEA/theme_1_bw/basic_animation/module_01/project/product/svg/character.svg')";
...
function stopWorker() {
    ...
    document.querySelector("#character").style.backgroundImage = "url('http://meetstephen.dk/KEA/theme_1_bw/basic_animation/module_01/project/product/svg/character_sad.svg')";
